...
function of_recognized_background_repeat() {
	$default = array(
		'no-repeat' => __( 'No Repeat', 'LotusDeveloper' ),
		'repeat-x'  => __( 'Repeat Horizontally', 'LotusDeveloper' ),
		'repeat-y'  => __( 'Repeat Vertically', 'LotusDeveloper' ),
		'repeat'    => __( 'Repeat All', 'LotusDeveloper' ),
		);
...
function of_recognized_background_position() {
	$default = array(
		'top left'      => __( 'Top Left', 'LotusDeveloper' ),
		'top center'    => __( 'Top Center', 'LotusDeveloper' ),
		'top right'     => __( 'Top Right', 'LotusDeveloper' ),
		'center left'   => __( 'Middle Left', 'LotusDeveloper' ),
		'center center' => __( 'Middle Center', 'LotusDeveloper' ),
		'center right'  => __( 'Middle Right', 'LotusDeveloper' ),
		'bottom left'   => __( 'Bottom Left', 'LotusDeveloper' ),
		'bottom center' => __( 'Bottom Center', 'LotusDeveloper' ),
		'bottom right'  => __( 'Bottom Right', 'LotusDeveloper')
		);
...
function of_recognized_background_attachment() {
	$default = array(
		'scroll' => __( 'Scroll Normally', 'LotusDeveloper' ),
		'fixed'  => __( 'Fixed in Place', 'LotusDeveloper')
		);
...
function of_recognized_font_styles() {
	$default = array(
		'normal'      => __( 'Normal', 'LotusDeveloper' ),
		'italic'      => __( 'Italic', 'LotusDeveloper' ),
		'bold'        => __( 'Bold', 'LotusDeveloper' ),
		'bold italic' => __( 'Bold Italic', 'LotusDeveloper' )
		);
