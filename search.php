<?php get_header();?>
	...
	<?php } ?>
				<?php  if( have_posts() ) : ?>
                    ...
                    <header class="title"><h2><?php
                        ...
                        if(!empty($search_query)){
                            echo 'نتیجه جستجوی شما عبارت "<span class="green">';
                            echo (the_search_query()); echo '</span> " است که ';
                        }
                        echo '"<span class="red">';
                        echo $wp_query -> found_posts;
                        echo '</span>" مقاله یا نوشته  برای شما یافت شد ';
                    ?></h2></header>
				...
				<?php else : ?>
					<header class="title"><h2>جستجوی شما نتیجه ای نداشت</h2></header>
				<?php endif;?>
